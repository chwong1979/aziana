...
**Current version pointer:** `package.json` = `0.4.4` (operational health proof endpoint `/api/health` for CommandOS Suite Truth — no public content/visual change. Prior `0.4.3`: homepage "waterfront" prose trim shipped 2026-06-27).
